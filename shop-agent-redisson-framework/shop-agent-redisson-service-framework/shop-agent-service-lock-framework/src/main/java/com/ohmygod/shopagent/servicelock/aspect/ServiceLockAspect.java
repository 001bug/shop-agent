package com.ohmygod.shopagent.servicelock.aspect;
...
import com.ohmygod.shopagent.servicelock.annotion.ServiceLock;
...
public class ServiceLockAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, ServiceLock servicelock) throws Throwable {
        ...
        if (result) {
            ...
            if (StringUtils.hasText(customLockTimeoutStrategy)) {
